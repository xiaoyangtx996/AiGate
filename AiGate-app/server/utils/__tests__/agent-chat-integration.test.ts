...
vi.mock('@/db/schema', () => ({
  agent: { id: 'id', name: 'name', model: 'model', systemPrompt: 'systemPrompt', temperature: 'temperature', maxTokens: 'maxTokens', organizationId: 'organizationId' },
  conversation: { id: 'id', agentId: 'agentId', userId: 'userId', title: 'title', messageCount: 'messageCount', updatedAt: 'updatedAt' },
  conversationMessage: { conversationId: 'conversationId', role: 'role', content: 'content', tokens: 'tokens', latency: 'latency', createdAt: 'createdAt' },
  apiLog: { userId: 'userId', agentId: 'agentId', organizationId: 'organizationId', model: 'model', provider: 'provider', type: 'type', totalTokens: 'totalTokens', latency: 'latency', statusCode: 'statusCode', status: 'status' },
}))
...
describe('agent-chat integration', () => {
  ...
  describe('sendAgentMessage', () => {
    ...
    it('should throw 503 when no channel is available', async () => {
      const agent = { id: 'agent-1', name: 'Bot', model: 'gpt-4o', systemPrompt: null, temperature: 30, maxTokens: 4096, organizationId: 'org-1' }
      mockSelect
