    ...
    pages: {
      ...
      aigate: {
        ...
        agents: {
          ...
          form: {
            createTitle: '创建 Agent', editTitle: '编辑 Agent', name: 'Agent 名称',
            namePlaceholder: '如：项目助手、代码审查 Agent', description: '描述', descriptionPlaceholder: '描述这个 Agent 的用途',
            model: '模型', systemPrompt: '系统提示词', systemPromptPlaceholder: '定义 Agent 的行为和能力...',
            temperature: '温度: {value}', maxTokens: '最大输出 Token', tags: '标签', tagPlaceholder: '输入标签后回车',
            notFound: '未找到 Agent', createSuccess: 'Agent 创建成功', updateSuccess: 'Agent 更新成功', updateFail: '更新失败',
            saveChanges: '保存修改', createAgent: '创建 Agent',
          },
          chatPage: {
            selectAgent: '选择 Agent', history: '历史对话', untitled: '未命名对话', export: '导出', newChat: '新对话',
            inputPlaceholder: '输入消息...', selectPrompt: '选择一个 Agent 开始对话', noReply: '暂无回复',
            requestFailed: '请求失败: {message}', checkGateway: '请检查网关配置',
            exportTitle: '对话导出', exportTime: '时间', exportModel: '模型', exportUser: '用户',
          },
          logs: {
    ...
    pages: {
      ...
      aigate: {
        ...
        agents: {
          ...
          form: {
            createTitle: 'Create Agent', editTitle: 'Edit Agent', name: 'Agent Name',
            namePlaceholder: 'e.g. Project Assistant, Code Review Agent', description: 'Description', descriptionPlaceholder: 'Describe what this agent does',
            model: 'Model', systemPrompt: 'System Prompt', systemPromptPlaceholder: 'Define agent behavior and capabilities...',
            temperature: 'Temperature: {value}', maxTokens: 'Max Output Tokens', tags: 'Tags', tagPlaceholder: 'Type a tag and press Enter',
            notFound: 'Agent not found', createSuccess: 'Agent created', updateSuccess: 'Agent updated', updateFail: 'Update failed',
            saveChanges: 'Save Changes', createAgent: 'Create Agent',
          },
          chatPage: {
            selectAgent: 'Select Agent', history: 'History', untitled: 'Untitled conversation', export: 'Export', newChat: 'New Chat',
            inputPlaceholder: 'Type a message...', selectPrompt: 'Select an agent to start chatting', noReply: 'No reply',
            requestFailed: 'Request failed: {message}', checkGateway: 'Check gateway configuration',
            exportTitle: 'Conversation Export', exportTime: 'Time', exportModel: 'Model', exportUser: 'User',
          },
          logs: {
