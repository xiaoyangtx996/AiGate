...
export const agent = pgTable(
  ...
  t => [index('agent_org_idx').on(t.organizationId), index('idx_agent_org_status').on(t.organizationId, t.status)],
)
...
export const alert = pgTable(
  ...
  t => [index('idx_alert_org_read_created').on(t.organizationId, t.read, t.createdAt)],
)
...
export const conversation = pgTable(
  ...
  t => [index('conv_agent_idx').on(t.agentId), index('conv_user_idx').on(t.userId)],
)
