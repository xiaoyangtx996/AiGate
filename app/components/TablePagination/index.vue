...
const from = computed(() => (props.total === 0 ? 0 : pagination.value.pageIndex * pagination.value.pageSize + 1))

const to = computed(() => Math.min((pagination.value.pageIndex + 1) * pagination.value.pageSize, props.total))
