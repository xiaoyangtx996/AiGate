        ...
        >
          <UContextMenu :items="getItems(tag)">
            ...
            >
              <template #trailing>
                <div
                  class="flex justify-center items-center rounded-full size-4 hover:bg-primary hover:text-inverted hover:cursor-auto transition-colors"
                  @click.stop.prevent="tabStore.closeTag(tag.to, router)"
                >
                  <UIcon name="lucide:x" />
                </div>
              </template>
