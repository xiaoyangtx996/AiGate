...
export function useSchema() {
  ...
  const zEmail = z
    ...
    .nonempty({ error: i18nCommon('required') })
    .meta({
  ...
  const signInFormSchema = z.object({
    ...
    rememberMe: z
      .boolean()
      .optional()
      .meta({ title: i18nAuth('signIn.rememberMe', true), theme: { floatRight: true } }),
  })
  ...
  const menuFormSchema = z.object({
    ...
    permissions: z
      .array(z.enum(PERMISSIONS.values))
      .optional()
      .meta({
