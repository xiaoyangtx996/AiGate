...
constraints:
  ...
  - domain must include Tenant, Organization, Project as first-class entities
...
success_criteria:
  ...
  - migrations create tenant/organization/project tables
  - README documents how to run migrate and start API stub
  - git status shows scaffold files under cmd/ internal/ migrations/
